...
// CODE HERE
const evenNumbers  = mixedNumbers.filter((n) => n % 2 === 0)
...
const totalPlusTax  = orders.reduce((a, c)=> {
  return a + c.price * (1 + c.tax)
}, 0)
...
// CODE HERE
const ownedByBarry  = purchases.filter((owner)=> {
  return owner.owner === "Barry"
})

const barryTotal  = ownedByBarry.reduce((a, c)=> {
  return a + c.price 
}, 0)
// console.log (barryTotal)
// const total = purchases.reduce((a, c) => a + c.price, 0)
// console.log(total)